...
namespace Senai.MaisVagas.WebApi.Controllers
{
    ...
    public class EmpresaController : ControllerBase
    {
        ...
        /// <returns>Uma empresa buscada e um status code 200 - Ok</returns>
        /// <response code="200">Retorna a empresa buscada</response>
        /// <response code="404">Retorna uma mensagem de erro</response>
        /// <response code="400">Retorna o erro gerado</response>
        [HttpGet("{id}")]
        [Authorize]
        public IActionResult ListarEmpresatoPorId(int id)
        {
            try
            {
